...
TABLE_CLICKED_INDICATOR: str
DEFAULT_MODAL_WINDOWS_ENABLED: bool
TAB_LOCATION_TOP: str
TAB_LOCATION_TOP_LEFT: str
TAB_LOCATION_TOP_RIGHT: str
TAB_LOCATION_LEFT: str
TAB_LOCATION_LEFT_TOP: str
TAB_LOCATION_LEFT_BOTTOM: str
TAB_LOCATION_RIGHT: str
TAB_LOCATION_RIGHT_TOP: str
TAB_LOCATION_RIGHT_BOTTOM: str
TAB_LOCATION_BOTTOM: str
TAB_LOCATION_BOTTOM_LEFT: str
TAB_LOCATION_BOTTOM_RIGHT: str
...
MENU_RIGHT_CLICK_EDITME_VER_LOC_EXIT: Any
...
ENABLE_MAC_MODAL_DISABLE_PATCH: bool
ENABLE_MAC_DISABLE_GRAB_ANYWHERE_WITH_TITLEBAR: bool
...
DEFAULT_USER_SETTINGS_TRINKET_PATH: str
DEFAULT_USER_SETTINGS_REPLIT_PATH: str
...
class Element:
    ...
    @property
    def widget(self): ...
    def bind(self, bind_string, key_modifier, propagate: bool = ...): ...
    ...
    def set_right_click_menu(self, menu: Any | None = ...) -> None: ...
...
class Input(Element):
    ...
    def __init__(
        ...
        pad: Any | None = ...,
        p: Any | None = ...,
        use_readonly_for_disable: bool = ...,
        readonly: bool = ...,
        disabled_readonly_background_color: Any | None = ...,
        disabled_readonly_text_color: Any | None = ...,
        expand_x: bool = ...,
        expand_y: bool = ...,
        right_click_menu: Any | None = ...,
        visible: bool = ...,
        metadata: Any | None = ...,
    ) -> None: ...
    def update(
...
class Multiline(Element):
    ...
    def update(
        ...
        text_color: Any | None = ...,
        background_color: Any | None = ...,
        text_color_for_value: Any | None = ...,
        background_color_for_value: Any | None = ...,
        visible: Any | None = ...,
        autoscroll: Any | None = ...,
        justification: Any | None = ...,
        font_for_value: Any | None = ...,
    ) -> None: ...
    def get(self): ...
    def print(
        self,
...
class Button(Element):
    ...
    def __init__(
        ...
        size=...,
        s=...,
        auto_size_button: Any | None = ...,
        button_color: Any | None = ...,
        disabled_button_color: Any | None = ...,
        highlight_colors: Any | None = ...,
        mouseover_colors=...,
        use_ttk_buttons: Any | None = ...,
        font: Any | None = ...,
        bind_return_key: bool = ...,
        focus: bool = ...,
        pad: Any | None = ...,
...
class Graph(Element):
    ...
    def draw_circle(
        self, center_location, radius, fill_color: Any | None = ..., line_color: str = ..., line_width: int = ...
    ): ...
    def draw_oval(
        self, top_left, bottom_right, fill_color: Any | None = ..., line_color: Any | None = ..., line_width: int = ...
    ): ...
    def draw_arc(
        self,
        top_left,
    ...
    def draw_polygon(
        self, points, fill_color: Any | None = ..., line_color: Any | None = ..., line_width: Any | None = ...
    ): ...
    def draw_text(
        self, text, location, color: str = ..., font: Any | None = ..., angle: int = ..., text_location=...
    ): ...
...
class TabGroup(Element):
    ...
    def __init__(
        self,
        layout,
        tab_location: Any | None = ...,
        title_color: Any | None = ...,
        tab_background_color: Any | None = ...,
        selected_title_color: Any | None = ...,
        selected_background_color: Any | None = ...,
        background_color: Any | None = ...,
        focus_color: Any | None = ...,
        font: Any | None = ...,
        change_submits: bool = ...,
        enable_events: bool = ...,
        pad: Any | None = ...,
    ...
    def get(self): ...
    def add_tab(self, tab_element) -> None: ...
    AddRow: Any
...
class Slider(Element):
    ...
    def __init__(
        ...
        default_value: Any | None = ...,
        resolution: Any | None = ...,
        tick_interval: Any | None = ...,
        orientation: Any | None = ...,
        disable_number_display: bool = ...,
        border_width: Any | None = ...,
        relief: Any | None = ...,
        change_submits: bool = ...,
        enable_events: bool = ...,
    ...
    def update(
        self, value: Any | None = ..., range=..., disabled: Any | None = ..., visible: Any | None = ...
    ) -> None: ...
    Update: Any
...
class Column(Element):
    ...
    def __init__(
        ...
        visible: bool = ...,
        justification: Any | None = ...,
        element_justification: Any | None = ...,
        vertical_alignment: Any | None = ...,
        grab: Any | None = ...,
        expand_x: Any | None = ...,
        expand_y: Any | None = ...,
...
class Table(Element):
    ...
    RowHeaderText: str
    enable_click_events: Any
    right_click_selects: Any
    last_clicked_position: Any
    HeaderBorderWidth: Any
    BorderWidth: Any
    HeaderRelief: Any
    ...
    def __init__(
        ...
        values,
        headings: Any | None = ...,
        visible_column_map: Any | None = ...,
        col_widths: Any | None = ...,
        def_col_width: int = ...,
        auto_size_columns: bool = ...,
        max_col_width: int = ...,
        select_mode: Any | None = ...,
        display_row_numbers: bool = ...,
        num_rows: Any | None = ...,
        row_height: Any | None = ...,
        font: Any | None = ...,
        justification: str = ...,
        text_color: Any | None = ...,
        background_color: Any | None = ...,
        alternating_row_color: Any | None = ...,
        selected_row_colors=...,
        header_text_color: Any | None = ...,
        header_background_color: Any | None = ...,
        header_font: Any | None = ...,
        header_border_width: Any | None = ...,
        header_relief: Any | None = ...,
        row_colors: Any | None = ...,
        vertical_scroll_only: bool = ...,
        ...
        change_submits: bool = ...,
        enable_events: bool = ...,
        enable_click_events: bool = ...,
        right_click_selects: bool = ...,
        bind_return_key: bool = ...,
        pad: Any | None = ...,
        p: Any | None = ...,
        key: Any | None = ...,
...
def Stretch(background_color: Any | None = ...): ...

Push = Stretch
P = Stretch

def VStretch(background_color: Any | None = ...): ...
...
class Window:
    ...
    Grab: Any
    GrabAnywhere: Any
    GrabAnywhereUsingControlKey: Any
    KeepOnTop: Any
    ForceTopLevel: Any
    Resizable: Any
    Timeout: Any
    ...
    def __init__(
        ...
        auto_size_text: Any | None = ...,
        auto_size_buttons: Any | None = ...,
        location=...,
        relative_location=...,
        size=...,
        element_padding: Any | None = ...,
        margins=...,
        button_color: Any | None = ...,
        font: Any | None = ...,
        progress_bar_color=...,
        background_color: Any | None = ...,
        border_depth: Any | None = ...,
        auto_close: bool = ...,
        auto_close_duration=...,
        icon: Any | None = ...,
        force_toplevel: bool = ...,
        ...
        keep_on_top: Any | None = ...,
        resizable: bool = ...,
        disable_close: bool = ...,
        disable_minimize: bool = ...,
        right_click_menu: Any | None = ...,
        transparent_color: Any | None = ...,
        debugger_enabled: bool = ...,
        right_click_menu_background_color: Any | None = ...,
        right_click_menu_text_color: Any | None = ...,
        right_click_menu_disabled_text_color: Any | None = ...,
        ...
        titlebar_background_color: Any | None = ...,
        titlebar_text_color: Any | None = ...,
        titlebar_font: Any | None = ...,
        titlebar_icon: Any | None = ...,
        use_custom_titlebar: Any | None = ...,
        scaling: Any | None = ...,
        metadata: Any | None = ...,
    ) -> None: ...
    @classmethod
    ...
    def FindElement(self, key, silent_on_error: bool = ...): ...
    ...
    def current_location(self, more_accurate: bool = ...): ...
    ...
    def bind(self, bind_string, key, propagate: bool = ...): ...
...
def MenubarCustom(
    ...
    background_color: Any | None = ...,
    text_color: Any | None = ...,
    bar_background_color: Any | None = ...,
    bar_text_color: Any | None = ...,
    key: Any | None = ...,
    k: Any | None = ...,
): ...
def FolderBrowse(
...
def CalendarButton(
    ...
    locale: Any | None = ...,
    format: str = ...,
    begin_at_sunday_plus: int = ...,
    month_names: Any | None = ...,
    day_abbreviations: Any | None = ...,
    title: str = ...,
    no_titlebar: bool = ...,
    location=...,
    metadata: Any | None = ...,
...
def AddMenuItem(
    top_menu, sub_menu_info, element, is_sub_menu: bool = ..., skip: bool = ..., right_click_menu: bool = ...
): ...
...
class Stylist:
    ...
    @staticmethod
    def get_options(ttkstyle, theme: Any | None = ...): ...
    @staticmethod
    def create_style(base_style: str, theme: Any | None = ..., **kwargs): ...
...
def set_options(
    ...
    font: Any | None = ...,
    border_width: Any | None = ...,
    slider_border_width: Any | None = ...,
    slider_relief: Any | None = ...,
    slider_orientation: Any | None = ...,
    autoclose_time: Any | None = ...,
    message_box_line_width: Any | None = ...,
    progress_meter_border_depth: Any | None = ...,
    progress_meter_style: Any | None = ...,
    progress_meter_relief: Any | None = ...,
    progress_meter_color: Any | None = ...,
    progress_meter_size: Any | None = ...,
    text_justification: Any | None = ...,
    background_color: Any | None = ...,
    element_background_color: Any | None = ...,
    text_element_background_color: Any | None = ...,
    input_elements_background_color: Any | None = ...,
    input_text_color: Any | None = ...,
    scrollbar_color: Any | None = ...,
    text_color: Any | None = ...,
    element_text_color: Any | None = ...,
    debug_win_size=...,
    window_location=...,
    error_button_color=...,
    tooltip_time: Any | None = ...,
    tooltip_font: Any | None = ...,
    use_ttk_buttons: Any | None = ...,
    ttk_theme: Any | None = ...,
    suppress_error_popups: Any | None = ...,
    suppress_raise_key_errors: Any | None = ...,
    suppress_key_guessing: Any | None = ...,
    warn_button_key_duplicates: bool = ...,
    enable_treeview_869_patch: Any | None = ...,
    enable_mac_notitlebar_patch: Any | None = ...,
    use_custom_titlebar: Any | None = ...,
    titlebar_background_color: Any | None = ...,
    titlebar_text_color: Any | None = ...,
    titlebar_font: Any | None = ...,
    ...
    pysimplegui_settings_path: Any | None = ...,
    pysimplegui_settings_filename: Any | None = ...,
    keep_on_top: Any | None = ...,
    dpi_awareness: Any | None = ...,
    scaling: Any | None = ...,
    disable_modal_windows: Any | None = ...,
    tooltip_offset=...,
): ...
...
def theme_previewer(
    columns: int = ..., scrollable: bool = ..., scroll_area_size=..., search_string: Any | None = ..., location=...
): ...
...
def popup_get_folder(
    ...
    modal: bool = ...,
    history: bool = ...,
    history_setting_filename: Any | None = ...,
): ...
def popup_get_file(
    message,
    title: Any | None = ...,
...
class UserSettings:
    ...
    def __init__(
        ...
        autosave: bool = ...,
        use_config_file: Any | None = ...,
        convert_bools_and_none: bool = ...,
    ) -> None: ...
    class _SectionDict:
        item_count: int
        section_name: Any
    ...
    def delete_entry(self, key, section: Any | None = ...) -> None: ...
...
EMOJI_BASE64_CRY: bytes
EMOJI_BASE64_DEAD: bytes
EMOJI_BASE64_FINGERS_CROSSED: bytes
EMOJI_BASE64_GUESS: bytes
EMOJI_BASE64_CLAP: bytes
EMOJI_BASE64_NO_HEAR: bytes
EMOJI_BASE64_NO_SEE: bytes
EMOJI_BASE64_NO_SPEAK: bytes
EMOJI_BASE64_PRAY: bytes
EMOJI_BASE64_ZIPPED_SHUT: bytes
EMOJI_BASE64_MIKE: bytes
EMOJI_BASE64_SUPERHERO: bytes
EMOJI_BASE64_HAPPY_LIST: Any
EMOJI_BASE64_SAD_LIST: Any
EMOJI_BASE64_LIST: Any
HEART_FLAT_BASE64: bytes
HEART_3D_BASE64: bytes
PYTHON_COLORED_HEARTS_BASE64: bytes
RED_X_BASE64: bytes
GREEN_CHECK_BASE64: bytes

def main_open_github_issue() -> None: ...

main_upgrade_from_github: Any
